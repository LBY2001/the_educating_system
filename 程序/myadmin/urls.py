...
urlpatterns = [
    ...
    path('member/del/<int:sid>', member.delete, name="myadmin_member_delete"), #执行删除

    # 选课开启
    path('select', index.select, name="myadmin_product_select"), #开启关闭选课
    path('selectchange/<int:sid>', index.selectchange, name="myadmin_selectchange"), #开启关闭选课
]